...
select '各app日活数据' model,
 ...
 where pt_days>='20190701' and pt_days<'20190715'
group by pt_days,
         appname;
select '-- -- -*******************************************************************************************************************-- -- -';
...
select '各app日活数据-剔除流量套餐' model,
   ...
   from 
        (select *
        from  user_action_app_d 
        where pt_days>='20190701' and pt_days<'20190715')  t1
     INNER join 
...
-- where pt_days>='20190601' and pt_days<'20190715'
...
from user_action_tag_d where  pt_days='20190705'  group by url_host;
