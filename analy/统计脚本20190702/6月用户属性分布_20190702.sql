...
select * from 
    ...
    from user_info_sample t  where pt_days='201904') a
where rn=1;
...
select  '信息流模块' app,
        '常驻省份分布' model,
        t1.top1_home_province,
        sum(case when t.pt_days='201904' and tag1=1 then 1 else 0 end) uv1,
        sum(case when t.pt_days='201904' and tag2=1 then 1 else 0 end) uv2,
        sum(case when t.pt_days='201904' and tag3=1 then 1 else 0 end) uv3,
        sum(case when t.pt_days='201904' and tag4=1 then 1 else 0 end) uv4,
        sum(case when t.pt_days='201905' and tag1=1 then 1 else 0 end) uv5,
        sum(case when t.pt_days='201905' and tag2=1 then 1 else 0 end) uv6,
        sum(case when t.pt_days='201905' and tag3=1 then 1 else 0 end) uv7,
        sum(case when t.pt_days='201905' and tag4=1 then 1 else 0 end) uv8
from 
