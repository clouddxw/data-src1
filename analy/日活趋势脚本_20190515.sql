...
select '各app日活数据' model,
 ...
 where pt_days>='20190508' and pt_days<'20190518'
group by pt_days,
         appname;
    ...
    from ( select pt_days,
            ...
            where  pt_days>='20190508' and pt_days<'20190518'
              and  (url_host in ('loggw.alipay.com','mdap.alipay.com','mcgw.alipay.com','mobilegw.alipay.com','mfbizweb.19ego.cn','api.mgzf.com',
                            ...
                            'cityboxapi.fruitday.com','api.95vintage.com','ai.wcar.net.cn','sky.vip.youku.com','csmobile.alipay.com','bxcloudstore.alicdn.com') 
...
from user_action_tag_d where  pt_days='20190513'  group by url_host;
